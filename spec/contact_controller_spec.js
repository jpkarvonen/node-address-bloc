...
describe("ContactController", () => {
  ...
  it("should be defined", () => {
    expect(this.book).toBeDefined();
  });

  describe("#addContact()", () => {

    it("should add a single contact into the book", (done) => {
      this.book.addContact("Alice", "001-101-1010", "alice@alice.org")
      .then((contact) => {
        expect(contact.name).toBe("Alice");
        expect(contact.phone).toBe("001-101-1010");
        expect(contact.email).toBe("alice@alice.org");
        done();
      })
      .catch((err) => {
        done();
  ...
  describe("search methods", () => {
    ...
    describe("#iterativeSearch()", () => {
      ...
      //utilizes spread syntax: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax
